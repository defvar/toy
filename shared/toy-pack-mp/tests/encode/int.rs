...
encode_pass!(
    ...
    encode_u64,
    1,
    vec![0xcf, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01]
);
...
encode_pass!(
    ...
    encode_i64,
    1,
    vec![0xd3, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01]
);
