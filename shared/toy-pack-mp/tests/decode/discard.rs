...
discard_pass!(
    u64,
    &[0xcf, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0xc0]
);
...
discard_pass!(
    i64,
    &[0xd3, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0xc0]
);

discard_pass!(f32, &[0xca, 0x01, 0x02, 0x03, 0x04, 0xc0]);
discard_pass!(
    f64,
    &[0xcb, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0xc0]
);
...
discard_pass!(
    fixext8,
    &[0xd7, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0xc0]
);
discard_pass!(
    fixext16,
    &[
        0xd8, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x10, 0x11, 0x12, 0x13,
        0x14, 0x15, 0x16, 0xc0
    ]
);
